...
cl /nologo /c /O2 /EHsc /GL /GR- /GS- /LD /MP /W4 /WL /D_EXPORTING /D_UNICODE /D_WINDOWS /DNDEBUG /DWIN32 /DUNICODE /Fobin\win32\ src\*.c src\*.cpp src\java\*.cpp
...
del bin\win32\*.obj bin\win32\Tolk.res
